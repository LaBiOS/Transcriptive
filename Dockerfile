...
COPY config/tools_1.yaml $GALAXY_ROOT/tools_1.yaml
COPY config/tools_2.yaml $GALAXY_ROOT/tools_2.yaml
COPY config/tools_3.yaml $GALAXY_ROOT/tools_3.yaml
COPY config/tools_4.yaml $GALAXY_ROOT/tools_4.yaml
RUN df -h && \
